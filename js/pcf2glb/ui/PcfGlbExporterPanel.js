...
function PcfGlbExporterPanel() {
  ...
  const logger = useMemo(() => createLogger(1e3), []);
  useEffect(() => {
    ...
    dirLight.position.set(100, 1e3, 100);
    scene.add(dirLight);
    const camera = new THREE.PerspectiveCamera(45, width / height, 1, 1e5);
    camera.position.set(5e3, 5e3, 5e3);
  ...
  return /* @__PURE__ */ React.createElement("div", { style: { padding: "20px", display: "flex", flexDirection: "column", gap: "20px", height: "100%", boxSizing: "border-box" } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center" } }, /* @__PURE__ */ React.createElement("h2", null, "PCF to GLB Export Pipeline"), /* @__PURE__ */ React.createElement("span", { style: { padding: "4px 8px", background: "#eee", borderRadius: "4px", fontWeight: "bold" } }, "Status: ", status)), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: "15px", alignItems: "center", background: "#f5f5f5", padding: "10px", borderRadius: "4px", flexWrap: "wrap" } }, /* @__PURE__ */ React.createElement("input", { type: "file", accept: ".pcf,.txt", onChange: handleFileChange }), /* @__PURE__ */ React.createElement("button", { onClick: () => runPipeline(), disabled: !file, style: { padding: "6px 12px" } }, "Run Pipeline (All Proxies)"), /* @__PURE__ */ React.createElement("button", { onClick: () => handlePreview(), disabled: !currentBlob, style: { padding: "6px 12px" } }, "Preview 3D"), /* @__PURE__ */ React.createElement("button", { onClick: handleDownload, disabled: !currentBlob, style: { padding: "6px 12px", background: "#4ec9b0", color: "black", border: "none", borderRadius: "3px" } }, "Download GLB"), /* @__PURE__ */ React.createElement("button", { onClick: handleClear, style: { padding: "6px 12px", marginLeft: "auto" } }, "Clear")), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: "20px", flex: 1, minHeight: "0", flexDirection: "row" } }, /* @__PURE__ */ React.createElement("div", { style: { flex: 1, border: "1px solid #ccc", borderRadius: "4px", overflow: "hidden" } }, /* @__PURE__ */ React.createElement("canvas", { ref: canvasRef, style: { width: "100%", height: "100%", display: "block" } })), /* @__PURE__ */ React.createElement("div", { style: { flex: 1, border: "1px solid #ccc", borderRadius: "4px", overflow: "hidden", display: "flex", flexDirection: "column" } }, /* @__PURE__ */ React.createElement(DebugConsole, { logger }))));
}
export {
  PcfGlbExporterPanel
};
